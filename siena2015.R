...
# course information
COURSE_ID = "TsinghuaX/30700313_2015X/2015_T1"
INSTRUCTORS = c("ruby-cai")

# read data
data = read_csv_files(c("data/threads.csv", "data/comments.csv"), 
                      c("id", "create_time", "user_id", "user_name", "course_id", "parent_id"),
                      sep = ";", dec = ",", na.strings = " ", stringsAsFactors = FALSE)
...
print01Report(net_data, net_effects, modelname = "output/descriptive")
